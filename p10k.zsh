# Generated by Powerlevel10k configuration wizard on 2022-04-23 at 22:51 EDT.
...
# sharp heads, sharp tails, 2 lines, dotted, left frame, sparse, fluent,
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_WIFI_VISUAL_IDENTIFIER_EXPANSION='直'

  # Use different colors and icons depending on signal strength ($P9K_WIFI_BARS).
  #
  #   # Wifi colors and icons for different signal strength levels (low to high).
     typeset -g my_wifi_fg=(70 90 110 130 150)                           # <-- change these values
     typeset -g my_wifi_icon=('直' '直' 'WiFi' 'WiFi' 'WiFi')     # <-- change these values
  #
